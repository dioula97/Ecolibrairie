...
?>
  <section class="col-md-12 col-lg-12 col-xs-12 col-sm-12" style="height: auto; margin-bottom: 1%; margin-top: -8px; border-bottom: 2px double white; background: url('images/photo.jpg'); color: black">
                <h1 style="text-align: center; color: #12f36a; text-shadow: 2px 2px 3px black; border-bottom: 1px solid">PROGRAMME ECO  TERMINAL</h1>
          ...
          <div class="col-md-55">
                        <div>
                          <div class="image view view-first">
                            <a href="mathsterminal.php?id=<?php echo $info_user['id']; ?>"><img style="width: 100%; display: block;" src="mathimage/math.png" alt="image" /></a>
                            <div class="mask">
                              <p>Mathématiques</p>
                            </div>
                          </div>
          ...
          <div class="col-md-55">
                      ...
                      <div class="col-md-55">
                        <div>
                          <div class="image< view view-first">
                            <a href="#"><img style="width: 100%; display: block;" src="mathimage/philo.png" alt="image" /></a>
                            <div class="mask">
                              <p>Philosophie</p>
                            </div>
                          </div>
                          <div class="caption">
                            <p style="font-size: 1.3em; font-weight: bold; text-align: center;">Philo</p>
                          </div>
                        </div>
                      </div>
