...
<section class="col-md-12 col-lg-12 col-xs-12 col-sm-12" style="height: auto; margin-bottom: 1%;background: DodgerBlue; border-bottom: 2px double white; border-radius: 6px">
 ...
 <div class="col-lg-6">
 	...
 	<h3 style="color: orange;">NUMERIQUES</h3>
 		<li style="color:blue"><span class="glyphicon glyphicon-book" style="color: blue"></span> Calculs dans R<a href="exos_maths/calculdansR.pdf" class="fa fa-download" style="font-size:30px;margin-left:4%;color:DodgerBlue;"></a><a href="exos_maths/calculnumerique.pdf" class="fa fa-download" style="font-size:30px;margin-left:4%;color:DodgerBlue;"></a></li>
 		<li style="color:blue"><span class="glyphicon glyphicon-book" style="color:blue"></span> Intervalles et Calculs Approchés<a href="exos_maths/calculapproche.pdf" class="fa fa-download" style="font-size:30px;margin-left:4%;color:DodgerBlue"></a></li>
        ...
        <li style="color:blue"><span class="glyphicon glyphicon-book"></span>Equations et Inéquations<a href="exos_maths/equationsinequations.pdf" class="fa fa-download" style="font-size:30px;margin-left:4%;color:DodgerBlue"></a></a></li>
  ...
  <ul style="font-size: 15pt; margin-right: 5em; list-style: none; color: white; line-height: 45px">
    <h3 style="color: orange;">GEOMETRIE</h3>
        <li style="color:blue"><span class="glyphicon glyphicon-book"></span>Calculs Vectoriels<a href="exos_maths/calculvectoriel.pdf" class="fa fa-download" style="font-size:30px;margin-left:4%;color:DodgerBlue"></a><a href="exos_maths/BARYCENTRE.pdf" class="fa fa-download" style="font-size:30px;margin-left:4%;color:DodgerBlue"></a></li>
        <li style="color:blue"><span class="glyphicon glyphicon-book"></span> Repérage Cartésien<a href="exos_maths/reperagecartesien.pdf" class="fa fa-download" style="font-size:30px;margin-left:4%;color:DodgerBlue"></a></a></li>
        <li style="color:blue"><span class="glyphicon glyphicon-book"></span> Angles et Trigonométrie<a href="exos_maths/anglesettrigonometrie.pdf" class="fa fa-download" style="font-size:30px;margin-left:4%;color:DodgerBlue"></a></a></li>
