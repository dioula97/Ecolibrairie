  ...
  if (isset($_GET['id']) AND $_GET['id'] > 0){
    ...
    <body style="background:grey">
      ...
      <section class="col-md-12 col-lg-12 col-xs-12 col-sm-12" style="height: auto; margin-bottom: 1%;background: DodgerBlue; border-bottom: 2px double white; border-radius: 6px">
        <h1 style="text-align: center; color: orange; text-shadow: 2px 2px 3px black">1<sup>ère</sup> ECO EXERCICES</h1>
      </section>
          ...
          <div class="col-md-4 col-sm-4 col-xs-6" >
            <div>
              <div class="image view view-first">
                <a href="exos_maths_premiere?id=<?php echo $info_user['id']; ?>"><img style="width: 100%; display: block; height:270px;" src="images/exo1.jpg" alt="image" /></a>
                <div class="mask">
                  <p>Mathématiques</p>
                </div>
              </div>
