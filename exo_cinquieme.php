...
<section class="col-md-12 col-lg-12 col-xs-12 col-sm-12" style="height: auto; margin-bottom: 1%;background: DodgerBlue; border-bottom: 2px double white; border-radius: 6px">
                <h1 style="text-align: center; color: orange; text-shadow: 2px 2px 3px black">5<sup>ème</sup> ECO EXERCICES</h1>
 </section>
 <div class="x_content" style="margin-top:-0.5%;background:white">
          ...
          <div class="col-md-4 col-sm-4 col-xs-6" >
                        <div>
                          <div class="image view view-first">
                            <a href="#?id=<?php echo $info_user['id']; ?>"><img style="width: 100%; display: block;" src="images/exo1.jpg" alt="image" /></a>
                            <div class="mask">
                              <p>Mathématiques</p>
                            </div>
                          </div>
                       ...
                       <div class="col-md-4 col-sm-4 col-xs-6" >
                        <div>
                          <div class="image view view-first">
                            <a href="#?id=<?php echo $info_user['id']; ?>"><img style="width: 100%; display: block;" src="images/exofranc2.jpg" alt="image" /></a>
                            <div class="mask">
                              <p>français</p>
                            </div>
                          </div>
       ...
       <div class="footer well" style="width: 100%; height: 120px; background: DodgerBlue; margin-top: 280px;">
